...
namespace SolarMax
{
    ...
    internal class QCommand
    {
        ...
        private static Dictionary<Keys, CommandCode> keyDictionary = new Dictionary<Keys, CommandCode>() { { Keys.Left,    CommandCode.LeftArrow },
        ...
        public QCommand(Keys Key, bool Shift, bool Control, bool Alt, string String = "", double Data = 0)
        {
            ...
            CommandCode kc;
            if (keyDictionary.TryGetValue(Key, out kc))
                this.CommandCode = kc;
            else
