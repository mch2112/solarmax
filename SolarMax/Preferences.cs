...
namespace SolarMax
{
    ...
    internal static class Preferences
    {
        ...
        public static float LabelFontSize
        {
            ...
            private set
            {
                labelFontSize = value.Clamp(3f, 16f);
            }
        }
        public static PlanetLabelType PlanetLabelType
        {
            get { return planetLabelType; }
            set
            {
                planetLabelType = value;
            }
        }
        static Preferences()
        {
            ...
            for (int i = 0; i <= s.GetUpperBound(0); i++)
            {
                switch (s[i, 0])
                {
                    ...
                    case "planet_label_type":
                        ...
                        {
                            case "both":
                                planetLabelType = SolarMax.PlanetLabelType.Both;
                                break;
                            case "symbol":
                            case "symbolonly":
                                planetLabelType = SolarMax.PlanetLabelType.SymbolOnly;
                                break;
                            case "name":
                            case "nameonly":
                                planetLabelType = SolarMax.PlanetLabelType.NameOnly;
                                break;
                        }
                        break;
#if DEBUG
