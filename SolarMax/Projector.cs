...
namespace SolarMax
{
    ...
    internal class Projector
    {
        ...
        private DampenerQuaternion pan; 
        ...
        public Projector(ProjectionMode ProjectionMode)
        {
            ...
            pan.AutoLockThreshold = 0.01;
            pan.NearLockThreshold = 0.02;
            pan.AutoLock = true;
        }
        ...
        public void PanInclination(double Amount)
        {
            panInclination += Amount * PAN_INCREMENT;
        }
        public void PanAzimuth(double Amount)
        {
            panAzimuth -= Amount * PAN_INCREMENT;
        }
        public void PanRotate(double Amount)
        {
            panRotate += Amount * TILT_INCREMENT;
        }
        public void ResetPanning()
        {
            pan.SetTarget(Quaternion.Identity, false);
        }
        public void Settle()
        {
            pan.LockAndTrack();
        }
        private Vector orientToCamera(ref Vector Target)
        {
            return projectionQ.RotateVectorFast(Target - this.Position);
        }
