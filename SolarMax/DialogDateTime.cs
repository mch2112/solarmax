...
namespace SolarMax
{
    internal sealed class DialogDateTime : Dialog
    {
        public delegate void DateTimeChange(DateTime Date);

        private DateTime minDate = new DateTime(1948, 1, 1, 0, 0, 0);
        private DateTime maxDate = new DateTime(2052, 12, 31, 23, 59, 59);

        private const float NUM_WIDTH = 36;
        private const float YEAR_WIDTH = 60;
        private const float BOX_HEIGHT = 40;

        private QRectangle[] rects = new QRectangle[7];
        ...
        private DateTimeChange changeCallback;
        ...
        {
            get { return string.Format("Set Date and Time to {0}", Util.GetDateString(this.DateTime, UTC)); }
        }
        ...
        private int NumBoxes { get { return UTC ? 6 : 7; } }
        ...
        {
            DateTime displayDate = this.date;
