...
internal sealed class LatLongDialog : Dialog
{
    ...
    public LatLongDialog(IRenderer Renderer, CloseCallback CloseCallback, LatLongChange ChangeCallback, double Latitude, double Longitude, QSize ScreenSize, QPen ForePen, QPen BorderPen, QPen BackPen) : base(Renderer, ScreenSize, CloseCallback, ForePen, BorderPen, BackPen)
    {
    ...
    {
        rect = screenSize.GetRectangleDockedBottomRight(new QSize(400, 195), 20);
