...
internal sealed class Quaternion
{
    ...
    public Quaternion Conjugate => new(this.W, -this.X, -this.Y, -this.Z);
    public Quaternion Negation => new(-W, -X, -Y, -Z);
    public static Quaternion operator +(Quaternion Q1, Quaternion Q2) 
        => new(Q1.W + Q2.W, Q1.X + Q2.X, Q1.Y + Q2.Y, Q1.Z + Q2.Z);
    public static Quaternion operator -(Quaternion Q1, Quaternion Q2) 
        => new(Q1.W - Q2.W, Q1.X - Q2.X, Q1.Y - Q2.Y, Q1.Z - Q2.Z);
    public static Quaternion operator *(Quaternion Q, double Multiplier) 
        => new(Q.W * Multiplier, Q.X * Multiplier, Q.Y * Multiplier, Q.Z * Multiplier);
    ...
    public static Quaternion operator /(Quaternion Q, double Divisor) 
        => new(Q.W / Divisor, Q.X / Divisor, Q.Y / Divisor, Q.Z / Divisor);
    public static Quaternion operator *(Quaternion Q1, Quaternion Q2)
    {
